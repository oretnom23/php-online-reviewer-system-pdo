<?php 
  ...
  $sql ="SELECT * FROM `questions` WHERE `user_id`='$id' AND  `difficulty_id` LIKE '%$difficulty_id%' AND `subject` LIKE '%$test_subject%' AND `Course` LIKE '%$test_desc%'";

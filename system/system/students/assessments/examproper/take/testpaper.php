...
else 
{
 ...
 //  $stmt =  $conn->prepare("SELECT * FROM studentdata_tests as ST, questions as Q where ST.test_id = '$id' and ST.student_id = '$user_id' and Q.q_id = ST.q_id LIMIT $record_index, $limit");
 //  $stmt->execute();

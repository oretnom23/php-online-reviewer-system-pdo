...
$user_id = $_SESSION['user_id'];
 $total_questions =$_SESSION['total_questions'];
  ...
  $stmt =  $conn->prepare("SELECT * FROM studentdata_tests as ST, questions as Q where ST.test_id = '$id' and ST.student_id = '$user_id' and Q.q_id = ST.q_id limit $total_questions");
  $stmt->execute();

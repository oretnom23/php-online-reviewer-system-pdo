...
$passing_rate =$_SESSION['passing_rate'];
  ...
  $stmt =  $conn->prepare("SELECT * FROM studentdata_tests as ST, questions as Q where ST.test_id = '$test_id' and ST.student_id = '$user_id' and Q.q_id = ST.q_id limit $total_questions");
  $stmt->execute();
...
$percentage = $percentage * 100;
  ...
  ?>
  <td colspan="2"> <?php if($mc_score >= $remark){
    echo $remarks = "PASSED";
    } 
    else{
      echo $remarks = "FAILED";
